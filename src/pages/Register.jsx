...
dispatch({type:"LOGIN_FAILED",payload:err.res?.data})
  ...
  return (
    <div>
        ...
        <div className="card absolute top-36  left-96 bg-black mx-16  ">
          
          <img className='opacity-45  relative'src="loginbg.png " alt="" />
       ...
       <div className="form-wrapper absolute top-44 left-32 ">
